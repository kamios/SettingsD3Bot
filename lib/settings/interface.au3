...
Func EditSettings($ProfilSel)
	...
	GUICtrlSetBkColor(-1,"-2")
	;Cracoucas mofification position ligne en dessous
	GUICtrlCreateLabel("BountyAct :",22,67,73,15,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	;Cracoucas mofification position ligne en dessous
	Global $InputBountyAct = GUICtrlCreateInput("",106,63,88,20,1,512)
	...
	;Cracoucas mofification position ligne en dessous
	Global $ChekboxEndSequence = GUICtrlCreateCheckbox("Quitter la séquence quand la prime est validée",22,143,255,21,-1,-1)
	...
	GUICtrlSetBkColor(-1,"-2")
	;Début Cracoucas / Modif position UsePath
	Global $CheckboxUsePath = GUICtrlCreateCheckbox("UsePath",610,185,63,23,-1,-1)
	Global $CheckboxAllIndestructibleObject = GUICtrlCreateCheckbox("Objets incassables",610,205,110,23,-1,-1)
	Global $CheckboxLegendaryPotion = GUICtrlCreateCheckbox("Potions légendaires",610, 225,110,23,-1,-1)
	;Fin Cracoucas
	...
	GUISwitch($settings,_GUICtrlTab_SetCurFocus($tab,1)&GUICtrlRead ($tab, 1))
	;Cracoucas mofification position ligne en dessous
	Global $CheckboxNoAdventure = GUICtrlCreateCheckbox("Pas de Prime : Séquence Aventure",22,83,201,20,-1,-1)
	;Début Cracoucas
	Global $CheckboxPauseAfterBounty = GUICtrlCreateCheckbox("Pause après les bountys",22,103,201,20,-1,-1)
	Global $CheckboxBountyAndSequence = GUICtrlCreateCheckbox("Enchaîne Séquence après les bountys",22,123,201,20,-1,-1)
	;Fin Cracoucas
	GUISwitch($settings,_GUICtrlTab_SetCurFocus($tab,4)&GUICtrlRead ($tab, 1))
