...
;---------------------------
	...
	GUICtrlCreateGroup("Gestion Raccourcis",18,69,259,170,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	Global $RadioBotTeam = GUICtrlCreateRadio("Bot en team",304,39,80,20,-1,-1)
	GUICtrlCreateLabel("CoseWindows :",23,87,75,15,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	Global $InputCloseWindows = GUICtrlCreateInput("",102,82,88,20,1,512)
	GUICtrlCreateLabel("Inventaire :",23,137,66,15,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	Global $InputMouseMove = GUICtrlCreateInput("",102,107,88,20,1,512)
	Global $InputInventory = GUICtrlCreateInput("",102,132,32,20,1,512)
	GUICtrlCreateLabel("MouseMove :",23,112,66,15,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	Global $InputPotions = GUICtrlCreateInput("",102,157,32,20,1,512)
	Global $InputPortal = GUICtrlCreateInput("",102,182,32,20,1,512)
	GUICtrlCreateLabel("Potions :",23,162,66,15,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	GUICtrlCreateLabel("Portal :",23,187,66,15,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	GUICtrlCreateLabel("Map :",23,212,50,15,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	Global $InputOpenMap = GUICtrlCreateInput("",102,207,32,20,1,512)
	Global $Inputkey1 = GUICtrlCreateInput("",230,132,32,20,1,512)
	Global $Inputkey2 = GUICtrlCreateInput("",230,157,32,20,1,512)
	Global $Inputkey3 = GUICtrlCreateInput("",230,182,32,20,1,512)
	Global $Inputkey4 = GUICtrlCreateInput("",230,207,32,20,1,512)
	GUICtrlCreateLabel("Key1 :",149,137,50,15,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	GUICtrlCreateLabel("Key2 :",149,162,50,15,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	GUICtrlCreateLabel("Key4 :",149,212,50,15,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	GUICtrlCreateLabel("Key3 :",149,187,50,15,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	GUICtrlCreateGroup("Gestion Pauses",284,69,174,95,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	GUICtrlCreateGroup("Gestion Loots",284,166,174,145,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	Global $CheckboxPause = GUICtrlCreateCheckbox("Pause",291,84,114,20,-1,-1)
	Global $InputApresXparties = GUICtrlCreateInput("",416,109,34,20,1,512)
	Global $InputTempsPause = GUICtrlCreateInput("",416,134,34,20,1,512)
	GUICtrlCreateLabel("Pause après X parties :",290,114,114,15,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	GUICtrlCreateLabel("Temps de Pause :",291,139,92,15,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	GUICtrlSetTip(-1,"Temps de pause en seconde ==> 6 min x 60 s = 360 s")
	GUICtrlCreateLabel("Objets stockés :",287,182,88,15,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	GUICtrlCreateLabel("Objets recyclés :",288,207,87,15,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	GUICtrlCreateLabel("Objets vendus :",288,232,87,15,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	Global $InputQualiteItemKeep = GUICtrlCreateInput("",378,177,69,20,1,512)
	Global $InputQualiteItemSalvage = GUICtrlCreateInput("",378,202,69,20,1,512)
	Global $InputQualiteItemSell = GUICtrlCreateInput("",378,227,69,20,1,512)
	Global $CheckboxFiltreNoID = GUICtrlCreateCheckbox("Non Identifié",287,277,150,20,-1,-1)
	Global $ComboUnknownItemAction = GUICtrlCreateCombo("",378,252,69,21,-1,-1)
	...
	GUICtrlCreateLabel("Type de Bot :",473,88,72,15,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	Global $ComboPM = GUICtrlCreateCombo("",549,133,100,21,-1,-1)
	GUICtrlSetData(-1,"Tourment1|Tourment2|Tourment3|Tourment4|Tourment5|Tourment6")
	Global $ComboDifficulte = GUICtrlCreateCombo("",549,108,100,21,-1,-1)
	GUICtrlSetData(-1,"Normal|Difficile|Expert|Calvaire|Tourment")
	GUICtrlCreateLabel("Difficulté :",473,113,72,15,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	GUICtrlCreateLabel("P. Monstres :",473,139,69,16,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	GUICtrlCreateLabel("Grablist :",473,164,69,15,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
...
;---------------------------
	...
	Global $CheckboxPauseAfterBounty = GUICtrlCreateCheckbox("Pause après les bountys",230,95,150,20,-1,-1)
	Global $CheckboxBountyAndSequence = GUICtrlCreateCheckbox("Enchaîne Séquences après les bountys",22,140,220,20,-1,-1)
;---------------------------
;Séquences
;---------------------------
...
;---------------------------
	...
	GUICtrlSetBkColor(-1,"-2")
	Global $CheckboxTakeGlobeInFight = GUICtrlCreateCheckbox("Globes en Combat",27,102,114,22,-1,-1)
	GUICtrlCreateGroup("Gestion Affixes",18,132,259,180,-1,-1)
	GUICtrlSetBkColor(-1,"-2")
	Global $CheckboxUsePath = GUICtrlCreateCheckbox("UsePath",609,187,63,23,-1,-1)
	Global $CheckboxAllIndestructibleObject = GUICtrlCreateCheckbox("Objets incassables",609,214,105,20,-1,-1)
	Global $CheckboxLegendaryPotion = GUICtrlCreateCheckbox("Potions Légendaires",152,101,114,22,-1,-1)
...
;---------------------------
	...
	GUICtrlSetBkColor(-1,"-2")
	Global $CheckboxNoEnergyForDecor = GUICtrlCreateCheckbox("Le bot n'utilisera pas de sort à énergie pour casser les éléments du décor",22,290,370,20,-1,-1)
;---------------------------
;Boutons
;---------------------------
	GUICtrlCreateTabItem("")
