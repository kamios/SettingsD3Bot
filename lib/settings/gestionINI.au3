...
Func SaveConfigs($FichierINI)
	...
	IniWrite($FichierINI, "Account info", "CloseWindows", $CloseWindows)
	IniWrite($FichierINI, "Account info", "Inventory", $Inventory)
	IniWrite($FichierINI, "Account info", "Potions", $Potions)
	IniWrite($FichierINI, "Account info", "Portal", $Portal)
	IniWrite($FichierINI, "Account info", "key1", $key1)
	IniWrite($FichierINI, "Account info", "key2", $key2)
	IniWrite($FichierINI, "Account info", "key3", $key3)
	IniWrite($FichierINI, "Account info", "key4", $key4)
	IniWrite($FichierINI, "Account info", "MouseMove", $MouseMove)
