...
;###########################################
	...
	$ListHeros = IniRead($FichierINI, "Run info", "ListHeros", "")
	$NbRunChangeHeros = IniRead($FichierINI, "Run info", "NbRunChangeHeros", "")
...
Func SaveConfigs($FichierINI)
	...
	IniWrite($FichierINI, "Run info", "ListHeros", $ListHeros)
	IniWrite($FichierINI, "Run info", "NbRunChangeHeros", $NbRunChangeHeros)
